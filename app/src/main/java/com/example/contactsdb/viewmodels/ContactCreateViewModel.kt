...
class ContactCreateViewModel(private val contactDao: ContactDao) : ViewModel() {
...
class ContactCreateViewModelFactory() : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(
        ...
        return ContactCreateViewModel(database.contactDao) as T
    }
}